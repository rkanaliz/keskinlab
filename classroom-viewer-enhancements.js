...
let overlay=null,viewerImage=null,counter=null,prevBtn=null,nextBtn=null,titleEl=null,fullscreenBtn=null,bottomEl=null;
let sources=[],index=0,mode='lightbox',nativeFullscreen=false,closing=false,touchStartX=null,restoreScrollY=0;

function isMobilePresentation(){return window.matchMedia('(max-width:1024px) and (pointer:coarse)').matches}
...
function mountStyles(){
 ...
 style.textContent=`
.viewer-launch{display:inline-flex;align-items:center;gap:7px;min-height:38px;margin-top:10px;padding:0 12px;border:1px solid var(--line-strong);border-radius:6px;background:rgba(255,255,255,.55);color:var(--ink);font:600 9px "IBM Plex Mono";letter-spacing:.04em;cursor:pointer}.viewer-launch:hover{border-color:var(--teal);color:var(--teal2)}.slide-card>img,.material-card>img[data-viewer-ready="1"]{cursor:zoom-in}.slide-card .viewer-launch{width:max-content}.keskinlab-viewer{position:fixed;inset:0;z-index:9999;display:none;grid-template-rows:auto minmax(0,1fr) auto;background:#12182B;color:#F4F6F3}.keskinlab-viewer.open{display:grid}.keskinlab-viewer-top{display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:1px solid rgba(244,246,243,.16)}.keskinlab-viewer-title{min-width:0;flex:1;font:600 10px "IBM Plex Mono";letter-spacing:.08em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.keskinlab-viewer-count{font:500 10px "IBM Plex Mono";color:rgba(244,246,243,.68)}.keskinlab-viewer-btn{display:inline-grid;place-items:center;min-width:42px;height:42px;padding:0 12px;border:1px solid rgba(244,246,243,.24);border-radius:7px;background:rgba(244,246,243,.06);color:#F4F6F3;font:600 10px "IBM Plex Mono";cursor:pointer}.keskinlab-viewer-btn:hover{background:rgba(244,246,243,.12)}.keskinlab-viewer-stage{position:relative;display:grid;place-items:center;min-height:0;overflow:hidden;box-sizing:border-box;padding:16px 72px}.keskinlab-viewer-stage img{display:block;width:auto;height:auto;max-width:calc(100vw - 168px);max-height:calc(100vh - 142px);max-height:calc(100dvh - 142px);object-fit:contain}.keskinlab-viewer-nav{position:absolute;top:50%;transform:translateY(-50%);width:48px;height:64px;padding:0}.keskinlab-viewer-prev{left:14px}.keskinlab-viewer-next{right:14px}.keskinlab-viewer-nav[hidden]{display:none}.keskinlab-viewer-bottom{display:flex;justify-content:center;align-items:center;gap:10px;min-height:46px;padding:7px 16px;border-top:1px solid rgba(244,246,243,.12);font:500 9px "IBM Plex Mono";color:rgba(244,246,243,.66)}.viewer-rotate-hint{display:none}.keskinlab-viewer.presentation{grid-template-rows:minmax(0,1fr)}.keskinlab-viewer.presentation .keskinlab-viewer-top{position:absolute;inset:0 0 auto;z-index:3;background:linear-gradient(rgba(18,24,43,.92),rgba(18,24,43,0));border:0;padding-bottom:28px;pointer-events:none}.keskinlab-viewer.presentation .keskinlab-viewer-top>*{pointer-events:auto}.keskinlab-viewer.presentation .keskinlab-viewer-title{font-size:16px}.keskinlab-viewer.presentation .keskinlab-viewer-count{font-size:16px}.keskinlab-viewer.presentation .keskinlab-viewer-stage{grid-row:1;padding:8px 12px}.keskinlab-viewer.presentation .keskinlab-viewer-stage img{width:100%;height:100%;max-width:100%;max-height:100%;object-fit:contain}.keskinlab-viewer.presentation .keskinlab-viewer-bottom{position:absolute;inset:auto 0 0;z-index:3;border:0;background:linear-gradient(rgba(18,24,43,0),rgba(18,24,43,.88));padding-top:24px;font-size:16px}.pdf-frame{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;overflow:hidden!important}.pdf-reader-link{display:none;align-items:center;justify-content:center;min-height:40px;margin-top:10px;padding:0 12px;border:1px solid var(--line-strong);border-radius:6px;background:rgba(255,255,255,.55);font:600 9px "IBM Plex Mono";letter-spacing:.04em}.pdf-reader-link:hover{border-color:var(--teal);color:var(--teal2)}body.viewer-open{overflow:hidden}
@media(max-width:1024px) and (pointer:coarse){.keskinlab-viewer{height:100dvh;min-height:100dvh}.keskinlab-viewer-stage{padding:10px 48px}.keskinlab-viewer-stage img{max-width:calc(100vw - 108px);max-height:calc(100dvh - 124px)}.keskinlab-viewer-nav{width:40px;height:54px}.keskinlab-viewer-prev{left:5px}.keskinlab-viewer-next{right:5px}.keskinlab-viewer-top{padding:9px 10px}.keskinlab-viewer-bottom{font-size:8px}.viewer-launch{min-height:36px}.pdf-frame{height:72dvh!important;min-height:460px!important}.pdf-reader-link{display:inline-flex}.keskinlab-viewer.presentation .keskinlab-viewer-stage{padding:8px 12px}.keskinlab-viewer.presentation .keskinlab-viewer-stage img{width:100%;height:100%;max-width:100%;max-height:100%}.keskinlab-viewer.presentation .keskinlab-viewer-title{font-size:16px}.keskinlab-viewer.presentation .keskinlab-viewer-count{font-size:16px}.keskinlab-viewer.presentation .keskinlab-viewer-bottom{font-size:16px}.keskinlab-viewer.presentation .keskinlab-viewer-native{display:none!important}}
@media(max-width:1024px) and (pointer:coarse) and (orientation:portrait){.keskinlab-viewer.presentation .keskinlab-viewer-stage{display:flex;flex-direction:column;justify-content:center;align-items:center;gap:22px;padding:76px 12px 72px}.keskinlab-viewer.presentation .keskinlab-viewer-stage img{width:100%;height:auto;max-width:100%;max-height:none;flex:0 0 auto;object-fit:contain}.keskinlab-viewer.presentation .viewer-rotate-hint{display:flex;position:static;z-index:4;transform:none;align-items:center;justify-content:center;gap:9px;max-width:320px;padding:12px 16px;border-radius:999px;background:rgba(244,246,243,.08);border:1px solid rgba(244,246,243,.22);font:600 15px "IBM Plex Mono";line-height:1.35;letter-spacing:.02em;text-align:center;color:#F4F6F3}.keskinlab-viewer.presentation .keskinlab-viewer-bottom{display:none}}
@media(max-width:1024px) and (pointer:coarse) and (orientation:landscape){.keskinlab-viewer.presentation .keskinlab-viewer-stage{padding:8px 12px}.keskinlab-viewer.presentation .keskinlab-viewer-stage img{width:100%;height:100%;max-width:100%;max-height:100%}.keskinlab-viewer.presentation .viewer-rotate-hint{display:none}.keskinlab-viewer.presentation .keskinlab-viewer-bottom{display:flex;min-height:34px;padding-bottom:3px}.keskinlab-viewer.presentation .keskinlab-viewer-top{padding-top:5px}}
...
function syncViewerCopy(){
 if(!bottomEl)return;
 bottomEl.textContent=mode==='fullscreen'&&isMobilePresentation()?'Kaydırarak ilerle':'← → ile değiştir · kaydırarak ilerle · Esc ile çık';
}
...
function updateFullscreenControl(){
 ...
 fullscreenBtn.hidden=mode!=='fullscreen'||isMobilePresentation()||!fullscreenMethod()||fullscreenElement()===overlay;
}

async function requestNativeFullscreen(){
 if(isMobilePresentation())return false;
...
async function openViewer(items,start=0,options={}){
 ...
 if(mode==='fullscreen'&&!isMobilePresentation())await requestNativeFullscreen();
}
...
window.addEventListener('orientationchange',()=>{if(overlay?.classList.contains('open')){syncViewerCopy();updateFullscreenControl()}});
window.visualViewport?.addEventListener('resize',()=>{if(overlay?.classList.contains('open')){syncViewerCopy();updateFullscreenControl()}});
})();
