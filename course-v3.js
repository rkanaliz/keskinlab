(function () {
  ...
  function renderWeek(n, opts) {
    ...
    if (n === 1 && D.links.week1Lesson) {
      actions.push('<a href="' + D.links.week1Lesson + '" class="btn btn-primary">Hafta 01 Ders Alanını Aç' +
  ...
  function renderTeacherWeekLinks(week) {
    ...
    var mats = D.materials[String(week.n)];
    if (mats) {
      if (mats['sunum'] && !(week.n === 1 && D.links.week1Lesson)) links.push('<a href="' + mats['sunum'][0] + '" class="teacher-link">Sınıf Sunumunu Aç</a>');
  ...
  (function siteChrome() {
    ...
    var SITE_COURSES = [
      { key: '5-sinif', label: '5. Sınıf BTY', page: '/5-sinif-bty', folder: '5sinif', suffix: '5sinif-bty' },
      { key: '6-sinif', label: '6. Sınıf BTY', page: '/6-sinif-bty', folder: '6sinif', suffix: '6sinif-bty' },
      { key: 'robotik', label: 'Robotik Kodlama', page: '/robotik-kodlama', folder: 'robotik', suffix: 'robotik-kodlama' },
      { key: 'yapay-zeka', label: 'Yapay Zekâ Uygulamaları', page: '/yapay-zeka', folder: 'yapay-zeka', suffix: 'yapay-zeka-uygulamalari' }
    ];
    ...
    function buildSearchIndex() {
      ...
      siteState.events.forEach(function (e) {
        addRecord('TAKVİM', e.label, e.date, '/takvim', e.date + ' ' + (e.end || ''), {});
      });
