...
for (const config of courses) {
  ...
  html = html.replaceAll('../', '/').replaceAll('homepage-v2.html', '/')
    ...
    .replaceAll('5-sinif-v3.css', '/course-v3.css?v=20260910m')
    .replaceAll('homepage-materials.js', '/site-materials.js')
    .replaceAll('5-sinif-v3-data.js', `/course-data-${config.key}.js?v=20260910m`)
    .replaceAll('5-sinif-v3.js', '/course-v3.js?v=20260910m')
  ...
  html = html.replace(`<script src="/course-data-${config.key}.js?v=20260910m"></script>`, `<script>window.KESKINLAB_COURSE=${legacyConfig};</script>\n<script src="/course-data-${config.key}.js?v=20260910m"></script>`);
